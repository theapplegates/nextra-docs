...
// src/index.tsx
import React45, { useMemo as useMemo5 } from "react";
...
// src/constants.tsx
import React40, { isValidElement } from "react";
...
var ActiveAnchorProvider = ({
  ...
  const [activeAnchor, setActiveAnchor2] = useState2({});
...
import React19, { useRef as useRef2, useEffect as useEffect2 } from "react";
...
function Search({
  ...
  }), renderString(config.search.loading)) : results.length > 0 ? results.map(({ route, prefix, children, id }, i) => /* @__PURE__ */ React21.createElement(Fragment, {
    key: id
...
function Head() {
  ...
  }, (_a = config.useNextSeoProps) == null ? void 0 : _a.call(config))), /* @__PURE__ */ React29.createElement(NextHead, null, config.faviconGlyph ? /* @__PURE__ */ React29.createElement("link", {
    rel: "icon",
...
var NavLinks = ({
  ...
  }), prev.title), next2 && /* @__PURE__ */ React30.createElement(Anchor, {
    href: next2.route,
    title: next2.title,
    className: cn11(
      classes2.link,
  ...
  }, next2.title, /* @__PURE__ */ React30.createElement(ArrowRightIcon, {
...
var classes3 = {
  ...
  active: cn12("nx-font-medium nx-subpixel-antialiased"),
  inactive: cn12(
...
function Navbar({ flatDirectories, items }) {
  ...
  return /* @__PURE__ */ React31.createElement("div", {
    ...
    }, page.title), /* @__PURE__ */ React31.createElement("span", {
    ...
    newWindow: true
  }, renderComponent(config.project.icon)) : null, config.chat.link ? /* @__PURE__ */ React31.createElement(Anchor, {
    className: "nx-p-2 nx-text-current",
    href: config.chat.link,
    newWindow: true
  }, renderComponent(config.chat.icon)) : null, renderComponent(config.navbar.extraContent), /* @__PURE__ */ React31.createElement("button", {
    type: "button",
    "aria-label": "Menu",
...
function Sidebar({
  ...
  return /* @__PURE__ */ React35.createElement(React35.Fragment, null, includePlaceholder && asPopover ? /* @__PURE__ */ React35.createElement("div", {
    ...
    directories: flatDirectories
  })), /* @__PURE__ */ React35.createElement(FocusedItemContext.Provider, {
    value: focused
  }, /* @__PURE__ */ React35.createElement(OnFocuseItemContext.Provider, {
    value: (item) => {
      setFocused(item);
    }
  }, /* @__PURE__ */ React35.createElement("div", {
...
var SkipNavLink = forwardRef3(
  function(_a, forwardedRef) {
    ...
    const className = providedClassName !== void 0 ? providedClassName : styled ? cn14(
      "nx-sr-only",
    ...
    return /* @__PURE__ */ React36.createElement("a", __spreadProps(__spreadValues({}, props), {
      ref: forwardedRef,
      href: `#${id || DEFAULT_ID}`,
      className,
...
var SkipNavContent = forwardRef3(
  function(_a, forwardedRef) {
    ...
    return /* @__PURE__ */ React36.createElement("div", __spreadProps(__spreadValues({}, props), {
      ref: forwardedRef,
      id: id || DEFAULT_ID
    }));
  }
...
import React38, { useEffect as useEffect5, useRef as useRef5, useMemo as useMemo3 } from "react";
...
function TOC({ headings, filePath }) {
  ...
  }, hasHeadings && /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement("p", {
    className: "nx-mb-4 nx-font-semibold nx-tracking-tight"
  }, renderComponent(config.toc.title)), /* @__PURE__ */ React38.createElement("ul", null, items.map(({ slug, text, depth }) => {
    var _a2;
    return /* @__PURE__ */ React38.createElement("li", {
      className: "nx-my-2 nx-scroll-my-6 nx-scroll-py-6",
      key: slug
    }, /* @__PURE__ */ React38.createElement("a", {
      href: `#${slug}`,
      className: cn16(
        {
          2: "nx-font-semibold",
  ...
  }))), hasMetaInfo && /* @__PURE__ */ React38.createElement("div", {
    className: cn16(
  ...
  }, config.feedback.content ? /* @__PURE__ */ React38.createElement(Anchor, {
...
import React39, { useMemo as useMemo4, useState as useState7 } from "react";
...
function MatchSorterSearch({
  ...
  const results = useMemo4(
    () => search ? matchSorter(directories, search, { keys: ["title"] }).map(
      ({ route, title }) => ({
        id: route + title,
        route,
        children: /* @__PURE__ */ React39.createElement(HighlightMatches, {
          value: title,
          match: search
        })
      })
  ...
  return /* @__PURE__ */ React39.createElement(Search, {
    value: search,
    onChange: setSearch,
    className,
...
var DEFAULT_THEME = {
  ...
  chat: {
    icon: /* @__PURE__ */ React40.createElement(React40.Fragment, null, /* @__PURE__ */ React40.createElement(DiscordIcon, null), /* @__PURE__ */ React40.createElement("span", {
      className: "nx-sr-only"
    }, "Discord"))
  },
  darkMode: true,
  ...
  editLink: {
    component({ className, filePath, children }) {
      ...
      return /* @__PURE__ */ React40.createElement(Anchor, {
        className,
        href: editUrl
      }, children);
    },
  ...
  feedback: {
    content: () => /* @__PURE__ */ React40.createElement(React40.Fragment, null, "Question? Give us feedback \u2192"),
    labels: "feedback"
  },
  footer: {
    component: Footer,
  ...
  gitTimestamp({ timestamp }) {
    ...
    return /* @__PURE__ */ React40.createElement(React40.Fragment, null, "Last updated on", " ", /* @__PURE__ */ React40.createElement("time", {
  ...
  head: /* @__PURE__ */ React40.createElement(React40.Fragment, null, /* @__PURE__ */ React40.createElement("meta", {
    name: "msapplication-TileColor",
    content: "#fff"
  }), /* @__PURE__ */ React40.createElement("meta", {
  ...
  i18n: [],
  logo: /* @__PURE__ */ React40.createElement(React40.Fragment, null, /* @__PURE__ */ React40.createElement("span", {
    className: "nx-font-extrabold"
  }, "Nextra"), /* @__PURE__ */ React40.createElement("span", {
  ...
  project: {
    icon: /* @__PURE__ */ React40.createElement(React40.Fragment, null, /* @__PURE__ */ React40.createElement(GitHubIcon, null), /* @__PURE__ */ React40.createElement("span", {
      className: "nx-sr-only"
    }, "GitHub"))
  },
  search: {
    component({ className, directories }) {
      const config = useConfig();
      return config.flexsearch ? /* @__PURE__ */ React40.createElement(Flexsearch, {
        className
      }) : /* @__PURE__ */ React40.createElement(MatchSorterSearch, {
        className,
        directories
      });
    },
    emptyResult: /* @__PURE__ */ React40.createElement("span", {
  ...
  sidebar: {
    ...
    titleComponent: ({ title }) => /* @__PURE__ */ React40.createElement(React40.Fragment, null, title)
  },
  toc: {
    component: TOC,
    float: true,
...
var Button = (_a) => {
  ...
  return /* @__PURE__ */ React41.createElement("button", __spreadValues2({
    className: [
...
var Pre = (_a) => {
  ...
  const [codeString, setCodeString] = useState22(value);
  ...
  return /* @__PURE__ */ React43.createElement(React43.Fragment, null, filename && /* @__PURE__ */ React43.createElement("div", {
    ...
    className: "nx-pointer-events-none nx-h-4 nx-w-4"
  })), codeString && /* @__PURE__ */ React43.createElement(CopyToClipboard, {
    value: codeString
  })));
};
...
var createHeaderLink = (Tag, context) => function HeaderLink(_a) {
  ...
  return /* @__PURE__ */ React44.createElement(Tag, __spreadValues({
    className: cn17(
  ...
  }, props), children, /* @__PURE__ */ React44.createElement("span", {
    className: "nx-absolute -nx-mt-20",
    id,
    ref: obRef
  }), /* @__PURE__ */ React44.createElement("a", {
    href: `#${id}`,
...
var Details = (_a) => {
  ...
  return /* @__PURE__ */ React44.createElement("details", __spreadValues(__spreadProps(__spreadValues({
  ...
  }), openState && { "data-expanded": true }), /* @__PURE__ */ React44.createElement(DetailsProvider, {
    value: setOpen
  }, summary), /* @__PURE__ */ React44.createElement(Collapse, {
    open: openState
  }, restChildren));
};
var Summary = (props) => {
  const setOpen = useDetails();
  return /* @__PURE__ */ React44.createElement("summary", __spreadProps(__spreadValues({
    className: cn17(
...
var A = (_a) => {
  ...
  return /* @__PURE__ */ React44.createElement(Anchor, __spreadValues({
    href,
...
var getComponents = ({
  ...
  return __spreadValues({
    h1: (props) => /* @__PURE__ */ React44.createElement("h1", __spreadValues({
    ...
    ul: (props) => /* @__PURE__ */ React44.createElement("ul", __spreadValues({
      className: "nx-mt-6 nx-list-disc first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
    }, props)),
    ol: (props) => /* @__PURE__ */ React44.createElement("ol", __spreadValues({
      className: "nx-mt-6 nx-list-decimal first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
    }, props)),
    li: (props) => /* @__PURE__ */ React44.createElement("li", __spreadValues({
      className: "nx-my-2"
    }, props)),
    blockquote: (props) => /* @__PURE__ */ React44.createElement("blockquote", __spreadValues({
      className: cn17(
    ...
    hr: (props) => /* @__PURE__ */ React44.createElement("hr", __spreadValues({
      className: "nx-my-8 dark:nx-border-gray-900"
    }, props)),
    a: (props) => /* @__PURE__ */ React44.createElement(A, __spreadProps(__spreadValues({}, props), {
      className: "nx-text-primary-600 nx-underline nx-decoration-from-font [text-underline-position:under]"
    })),
    table: (props) => /* @__PURE__ */ React44.createElement(Table, __spreadValues({
      className: "nextra-scrollbar nx-mt-6 nx-p-0 first:nx-mt-0"
    }, props)),
    p: (props) => /* @__PURE__ */ React44.createElement("p", __spreadValues({
...
var Body = ({
  ...
  const gitTimestampEl = mounted && date ? /* @__PURE__ */ React45.createElement("div", {
    className: "nx-mt-12 nx-mb-8 nx-block nx-text-xs nx-text-gray-500 ltr:nx-text-right rtl:nx-text-left dark:nx-text-gray-400"
  }, renderComponent(config.gitTimestamp, { timestamp: date })) : /* @__PURE__ */ React45.createElement("div", {
    className: "nx-mt-16"
  });
  const content = /* @__PURE__ */ React45.createElement(React45.Fragment, null, children, gitTimestampEl, navigation);
  const body = ((_a = config.main) == null ? void 0 : _a.call(config, { children: content })) || content;
  if (themeContext.layout === "full") {
    return /* @__PURE__ */ React45.createElement("article", {
  ...
  }, /* @__PURE__ */ React45.createElement("main", {
...
var InnerLayout = ({
  ...
  const tocEl = activeType === "page" || !themeContext.toc || themeContext.layout !== "default" ? themeContext.layout !== "full" && themeContext.layout !== "raw" && /* @__PURE__ */ React45.createElement("nav", {
    className: tocClassName,
    "aria-label": "table of contents"
  }) : /* @__PURE__ */ React45.createElement("nav", {
    className: cn18(tocClassName, "nx-px-4"),
    "aria-label": "table of contents"
  ...
  return /* @__PURE__ */ React45.createElement("div", {
    dir: direction
  }, /* @__PURE__ */ React45.createElement("script", {
    dangerouslySetInnerHTML: {
      __html: `document.documentElement.setAttribute('dir','${direction}')`
    }
  }), /* @__PURE__ */ React45.createElement(Head, null), /* @__PURE__ */ React45.createElement(Banner, null), themeContext.navbar && renderComponent(config.navbar.component, {
    flatDirectories,
  ...
  }, /* @__PURE__ */ React45.createElement(ActiveAnchorProvider, null, /* @__PURE__ */ React45.createElement(Sidebar, {
    docsDirectories,
    flatDirectories,
  ...
  }), tocEl, /* @__PURE__ */ React45.createElement(SkipNavContent, null), /* @__PURE__ */ React45.createElement(Body, {
    themeContext,
    breadcrumb: activeType !== "page" && themeContext.breadcrumb ? /* @__PURE__ */ React45.createElement(Breadcrumb, {
      activePath
    }) : null,
    timestamp,
    navigation: activeType !== "page" && themeContext.pagination ? /* @__PURE__ */ React45.createElement(NavLinks, {
      flatDirectories: flatDocsDirectories,
      currentIndex: activeIndex
    }) : null
  }, /* @__PURE__ */ React45.createElement(MDXProvider, {
...
function Layout(props) {
  ...
  return /* @__PURE__ */ React45.createElement(ConfigProvider, {
    value: context
  }, /* @__PURE__ */ React45.createElement(InnerLayout, __spreadValues({}, pageOpts), /* @__PURE__ */ React45.createElement(Content, __spreadValues({}, props))));
}
export {
  Bleed,
  Callout,
