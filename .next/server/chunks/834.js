...
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3517);
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_link__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_module_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1649);
...
function Card({ children , title , icon , image , arrow , demo , href , ...props }) {
    ...
    if (image) {
        return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((next_link__WEBPACK_IMPORTED_MODULE_2___default()), {
            href: href,
            className: clsx__WEBPACK_IMPORTED_MODULE_1___default()((_style_module_css__WEBPACK_IMPORTED_MODULE_3___default().card), "group flex flex-col justify-start overflow-hidden rounded-lg border border-gray-200 bg-gray-100 text-current no-underline shadow shadow-gray-100 transition-all duration-200 dark:border-neutral-700 dark:bg-neutral-800 dark:text-gray-50 dark:shadow-none", "hover:border-gray-300 hover:shadow-lg hover:shadow-gray-100 dark:hover:border-neutral-500 dark:hover:bg-neutral-700 dark:hover:shadow-none", "active:shadow-sm active:shadow-gray-200"),
            ...props,
            children: [
                children,
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                    className: clsx__WEBPACK_IMPORTED_MODULE_1___default()((_style_module_css__WEBPACK_IMPORTED_MODULE_3___default().title), "gap-2 p-4 text-gray-700 dark:text-gray-300", "hover:text-gray-900 dark:hover:text-gray-100"),
                    children: [
                        icon,
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
