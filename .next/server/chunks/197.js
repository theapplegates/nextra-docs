...
var _extends = __webpack_require__(1477);
...
var _normalizeTrailingSlash = __webpack_require__(2497);
...
var _head = _interop_require_default(__webpack_require__(8363));
...
var _router = __webpack_require__(5314);
var _formatUrl = __webpack_require__(3938);
var _addLocale = __webpack_require__(4829);
var _routerContext = __webpack_require__(4964);
var _appRouterContext = __webpack_require__(3280);
var _useIntersection = __webpack_require__(6283);
var _getDomainLocale = __webpack_require__(7077);
var _addBasePath = __webpack_require__(7465);
...
var _hasBasePath = __webpack_require__(5431);
const basePath =  false || "";
...
var _trustedTypes = __webpack_require__(4784);
var _requestIdleCallback = __webpack_require__(5308);
...
var _headManager = __webpack_require__(7373);
var _requestIdleCallback = __webpack_require__(5308);
...
var _normalizeTrailingSlash = __webpack_require__(2497);
var _removeTrailingSlash = __webpack_require__(3297);
var _routeLoader = __webpack_require__(6205);
var _script = __webpack_require__(471);
var _isError = _interop_require_wildcard(__webpack_require__(4108));
...
var _formatUrl = __webpack_require__(3938);
var _detectDomainLocale = __webpack_require__(7025);
var _parsePath = __webpack_require__(8854);
var _addLocale = __webpack_require__(4829);
var _removeLocale = __webpack_require__(2726);
var _removeBasePath = __webpack_require__(6610);
var _addBasePath = __webpack_require__(7465);
var _hasBasePath = __webpack_require__(5431);
var _isApiRoute = __webpack_require__(4076);
...
module.exports = __webpack_require__(6916)
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "mQ": () => (/* binding */ Tabs),
  "ZP": () => (/* binding */ Layout),
  "ZR": () => (/* binding */ useConfig)
});

// UNUSED EXPORTS: Bleed, Collapse, Navbar, NotFoundPage, ServerSideErrorPage, SkipNavContent, SkipNavLink, ThemeSwitch, useMDXComponents, useTheme
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@mdx-js+react@2.2.1_react@18.2.0/node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(313);
;// CONCATENATED MODULE: ./node_modules/.pnpm/next@13.1.1_biqbaboplfbrettd7655fr4n2y/node_modules/next/package.json
const package_namespaceObject = {"i8":"13.1.1"};
// EXTERNAL MODULE: ./node_modules/.pnpm/next@13.1.1_biqbaboplfbrettd7655fr4n2y/node_modules/next/link.js
var next_link = __webpack_require__(3517);
var link_default = /*#__PURE__*/__webpack_require__.n(next_link);
// EXTERNAL MODULE: ./node_modules/.pnpm/next-themes@0.2.1_q76c2b4vyoegvsbrcwkfvimnai/node_modules/next-themes/dist/index.js
var dist = __webpack_require__(3604);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@headlessui+react@1.7.7_biqbaboplfbrettd7655fr4n2y/node_modules/@headlessui/react/dist/internal/open-closed.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@headlessui+react@1.7.7_biqbaboplfbrettd7655fr4n2y/node_modules/@headlessui/react/dist/utils/disposables.js
...
function v(t,...e){t&&e.length>0&&t.classList.add(...e)}function transition_f(t,...e){t&&e.length>0&&t.classList.remove(...e)}function transition_F(t,e){let n=disposables_m();if(!t)return n.dispose;let{transitionDuration:a,transitionDelay:i}=getComputedStyle(t),[m,d]=[a,i].map(o=>{let[r=0]=o.split(",").filter(Boolean).map(l=>l.includes("ms")?parseFloat(l):parseFloat(l)*1e3).sort((l,g)=>g-l);return r});if(m+d!==0){let o=n.addEventListener(t,"transitionend",r=>{r.target===r.currentTarget&&(e(),o())})}else e();return n.add(()=>e()),n.dispose}function M(t,e,n,a){let i=n?"enter":"leave",m=disposables_m(),d=a!==void 0?l(a):()=>{};i==="enter"&&(t.removeAttribute("hidden"),t.style.display="");let u=match_u(i,{enter:()=>e.enter,leave:()=>e.leave}),o=match_u(i,{enter:()=>e.enterTo,leave:()=>e.leaveTo}),r=match_u(i,{enter:()=>e.enterFrom,leave:()=>e.leaveFrom});return transition_f(t,...e.enter,...e.enterTo,...e.enterFrom,...e.leave,...e.leaveFrom,...e.leaveTo,...e.entered),v(t,...u,...r),m.nextFrame(()=>{transition_f(t,...r),v(t,...o),transition_F(t,()=>(transition_f(t,...u),v(t,...e.entered),d()))}),m.dispose}

;// CONCATENATED MODULE: ./node_modules/.pnpm/@headlessui+react@1.7.7_biqbaboplfbrettd7655fr4n2y/node_modules/@headlessui/react/dist/hooks/use-disposables.js
...
function use_transition_D({container:i,direction:t,classes:o,onStart:s,onStop:u}){let a=f(),c=use_disposables_p(),r=use_latest_value_s(t);use_iso_morphic_effect_s(()=>{let e=disposables_m();c.add(e.dispose);let n=i.current;if(!!n&&r.current!=="idle"&&!!a.current)return e.dispose(),s.current(r.current),e.add(M(n,o.current,r.current==="enter",()=>{e.dispose(),u.current(r.current)})),e.dispose},[t])}
...
function P(i=""){return i.split(" ").filter(e=>e.trim().length>1)}let A=(0,external_react_.createContext)(null);A.displayName="TransitionContext";var Ce=(s=>(s.Visible="visible",s.Hidden="hidden",s))(Ce||{});function ge(){let i=(0,external_react_.useContext)(A);if(i===null)throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");return i}function be(){let i=(0,external_react_.useContext)(transition_M);if(i===null)throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");return i}let transition_M=(0,external_react_.createContext)(null);transition_M.displayName="NestingContext";function I(i){return"children"in i?I(i.children):i.current.filter(({el:e})=>e.current!==null).filter(({state:e})=>e==="visible").length>0}function ne(i,e){let s=use_latest_value_s(i),n=(0,external_react_.useRef)([]),m=f(),R=use_disposables_p(),b=use_event_o((l,r=render_j.Hidden)=>{let t=n.current.findIndex(({el:o})=>o===l);t!==-1&&(match_u(r,{[render_j.Unmount](){n.current.splice(t,1)},[render_j.Hidden](){n.current[t].state="hidden"}}),R.microTask(()=>{var o;!I(n)&&m.current&&((o=s.current)==null||o.call(s))}))}),E=use_event_o(l=>{let r=n.current.find(({el:t})=>t===l);return r?r.state!=="visible"&&(r.state="visible"):n.current.push({el:l,state:"visible"}),()=>b(l,render_j.Unmount)}),S=(0,external_react_.useRef)([]),u=(0,external_react_.useRef)(Promise.resolve()),p=(0,external_react_.useRef)({enter:[],leave:[],idle:[]}),d=use_event_o((l,r,t)=>{S.current.splice(0),e&&(e.chains.current[r]=e.chains.current[r].filter(([o])=>o!==l)),e==null||e.chains.current[r].push([l,new Promise(o=>{S.current.push(o)})]),e==null||e.chains.current[r].push([l,new Promise(o=>{Promise.all(p.current[r].map(([f,a])=>a)).then(()=>o())})]),r==="enter"?u.current=u.current.then(()=>e==null?void 0:e.wait.current).then(()=>t(r)):t(r)}),v=use_event_o((l,r,t)=>{Promise.all(p.current[r].splice(0).map(([o,f])=>f)).then(()=>{var o;(o=S.current.shift())==null||o()}).then(()=>t(r))});return (0,external_react_.useMemo)(()=>({children:n,register:E,unregister:b,onStart:d,onStop:v,wait:u,chains:p}),[E,b,n,d,v,p,u])}function Ee(){}let Se=["beforeEnter","afterEnter","beforeLeave","afterLeave"];function re(i){var s;let e={};for(let n of Se)e[n]=(s=i[n])!=null?s:Ee;return e}function xe(i){let e=(0,external_react_.useRef)(re(i));return (0,external_react_.useEffect)(()=>{e.current=re(i)},[i]),e}let Pe="div",ie=S.RenderStrategy,oe=C(function(e,s){let{beforeEnter:n,afterEnter:m,beforeLeave:R,afterLeave:b,enter:E,enterFrom:S,enterTo:u,entered:p,leave:d,leaveFrom:v,leaveTo:l,...r}=e,t=(0,external_react_.useRef)(null),o=use_sync_refs_y(t,s),f=r.unmount?render_j.Unmount:render_j.Hidden,{show:a,appear:x,initial:se}=ge(),[h,_]=(0,external_react_.useState)(a?"visible":"hidden"),K=be(),{register:D,unregister:V}=K,j=(0,external_react_.useRef)(null);(0,external_react_.useEffect)(()=>D(t),[D,t]),(0,external_react_.useEffect)(()=>{if(f===render_j.Hidden&&!!t.current){if(a&&h!=="visible"){_("visible");return}return match_u(h,{["hidden"]:()=>V(t),["visible"]:()=>D(t)})}},[h,t,D,V,a,f]);let U=use_latest_value_s({enter:P(E),enterFrom:P(S),enterTo:P(u),entered:P(p),leave:P(d),leaveFrom:P(v),leaveTo:P(l)}),w=xe({beforeEnter:n,afterEnter:m,beforeLeave:R,afterLeave:b}),k=use_server_handoff_complete_a();(0,external_react_.useEffect)(()=>{if(k&&h==="visible"&&t.current===null)throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?")},[t,h,k]);let G=se&&!x,le=(()=>!k||G||j.current===a?"idle":a?"enter":"leave")(),ae=use_event_o(C=>match_u(C,{enter:()=>w.current.beforeEnter(),leave:()=>w.current.beforeLeave(),idle:()=>{}})),ue=use_event_o(C=>match_u(C,{enter:()=>w.current.afterEnter(),leave:()=>w.current.afterLeave(),idle:()=>{}})),L=ne(()=>{_("hidden"),V(t)},K);use_transition_D({container:t,classes:U,direction:le,onStart:use_latest_value_s(C=>{L.onStart(t,C,ae)}),onStop:use_latest_value_s(C=>{L.onStop(t,C,ue),C==="leave"&&!I(L)&&(_("hidden"),V(t))})}),(0,external_react_.useEffect)(()=>{!G||(f===render_j.Hidden?j.current=null:j.current=a)},[a,G,h]);let B=r,de={ref:o};return x&&a&&(typeof window=="undefined"||typeof document=="undefined")&&(B={...B,className:class_names_e(r.className,...U.current.enter,...U.current.enterFrom)}),external_react_.createElement(transition_M.Provider,{value:L},external_react_.createElement(open_closed_C,{value:match_u(h,{["visible"]:open_closed_p.Open,["hidden"]:open_closed_p.Closed})},$({ourProps:de,theirProps:B,defaultTag:Pe,features:ie,visible:h==="visible",name:"Transition.Child"})))}),J=C(function(e,s){let{show:n,appear:m=!1,unmount:R,...b}=e,E=(0,external_react_.useRef)(null),S=use_sync_refs_y(E,s);use_server_handoff_complete_a();let u=open_closed_s();if(n===void 0&&u!==null&&(n=match_u(u,{[open_closed_p.Open]:!0,[open_closed_p.Closed]:!1})),![!0,!1].includes(n))throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");let[p,d]=(0,external_react_.useState)(n?"visible":"hidden"),v=ne(()=>{d("hidden")}),[l,r]=(0,external_react_.useState)(!0),t=(0,external_react_.useRef)([n]);use_iso_morphic_effect_s(()=>{l!==!1&&t.current[t.current.length-1]!==n&&(t.current.push(n),r(!1))},[t,n]);let o=(0,external_react_.useMemo)(()=>({show:n,appear:m,initial:l}),[n,m,l]);(0,external_react_.useEffect)(()=>{if(n)d("visible");else if(!I(v))d("hidden");else{let a=E.current;if(!a)return;let x=a.getBoundingClientRect();x.x===0&&x.y===0&&x.width===0&&x.height===0&&d("hidden")}},[n,v]);let f={unmount:R};return external_react_.createElement(transition_M.Provider,{value:v},external_react_.createElement(A.Provider,{value:o},$({ourProps:{...f,as:external_react_.Fragment,children:external_react_.createElement(oe,{ref:S,...f,...b})},theirProps:{},defaultTag:external_react_.Fragment,features:ie,visible:p==="visible",name:"Transition"})))}),ye=C(function(e,s){let n=(0,external_react_.useContext)(A)!==null,m=open_closed_s()!==null;return external_react_.createElement(external_react_.Fragment,null,!n&&m?external_react_.createElement(J,{ref:s,...e}):external_react_.createElement(oe,{ref:s,...e}))}),Je=Object.assign(J,{Child:ye,Root:J});
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@headlessui+react@1.7.7_biqbaboplfbrettd7655fr4n2y/node_modules/@headlessui/react/dist/utils/calculate-active-index.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@headlessui+react@1.7.7_biqbaboplfbrettd7655fr4n2y/node_modules/@headlessui/react/dist/utils/bugs.js
...
let focus_management_f=["[contentEditable=true]","[tabindex]","a[href]","area[href]","button:not([disabled])","iframe","input:not([disabled])","select:not([disabled])","textarea:not([disabled])"].map(e=>`${e}:not([tabindex='-1'])`).join(",");var focus_management_L=(n=>(n[n.First=1]="First",n[n.Previous=2]="Previous",n[n.Next=4]="Next",n[n.Last=8]="Last",n[n.WrapAround=16]="WrapAround",n[n.NoScroll=32]="NoScroll",n))(focus_management_L||{}),focus_management_N=(o=>(o[o.Error=0]="Error",o[o.Overflow=1]="Overflow",o[o.Success=2]="Success",o[o.Underflow=3]="Underflow",o))(focus_management_N||{}),focus_management_T=(r=>(r[r.Previous=-1]="Previous",r[r.Next=1]="Next",r))(focus_management_T||{});function E(e=document.body){return e==null?[]:Array.from(e.querySelectorAll(focus_management_f)).sort((t,r)=>Math.sign((t.tabIndex||Number.MAX_SAFE_INTEGER)-(r.tabIndex||Number.MAX_SAFE_INTEGER)))}var focus_management_F=(r=>(r[r.Strict=0]="Strict",r[r.Loose=1]="Loose",r))(focus_management_F||{});function focus_management_h(e,t=0){var r;return e===((r=owner_e(e))==null?void 0:r.body)?!1:match_u(t,{[0](){return e.matches(focus_management_f)},[1](){let l=e;for(;l!==null;){if(l.matches(focus_management_f))return!0;l=l.parentElement}return!1}})}function focus_management_v(e){let t=owner_e(e);disposables_m().nextFrame(()=>{t&&!focus_management_h(t.activeElement,0)&&focus_management_S(e)})}function focus_management_S(e){e==null||e.focus({preventScroll:!0})}let H=["textarea","input"].join(",");function focus_management_w(e){var t,r;return(r=(t=e==null?void 0:e.matches)==null?void 0:t.call(e,H))!=null?r:!1}function focus_management_A(e,t=r=>r){return e.slice().sort((r,l)=>{let o=t(r),i=t(l);if(o===null||i===null)return 0;let n=o.compareDocumentPosition(i);return n&Node.DOCUMENT_POSITION_FOLLOWING?-1:n&Node.DOCUMENT_POSITION_PRECEDING?1:0})}function focus_management_g(e,t){return focus_management_I(E(),t,{relativeTo:e})}function focus_management_I(e,t,{sorted:r=!0,relativeTo:l=null,skipElements:o=[]}={}){let i=Array.isArray(e)?e.length>0?e[0].ownerDocument:document:e.ownerDocument,n=Array.isArray(e)?r?focus_management_A(e):e:E(e);o.length>0&&(n=n.filter(s=>!o.includes(s))),l=l!=null?l:i.activeElement;let d=(()=>{if(t&5)return 1;if(t&10)return-1;throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last")})(),x=(()=>{if(t&1)return 0;if(t&2)return Math.max(0,n.indexOf(l))-1;if(t&4)return Math.max(0,n.indexOf(l))+1;if(t&8)return n.length-1;throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last")})(),p=t&32?{preventScroll:!0}:{},c=0,a=n.length,u;do{if(c>=a||c+a<=0)return 0;let s=x+c;if(t&16)s=(s+a)%a;else{if(s<0)return 3;if(s>=a)return 1}u=n[s],u==null||u.focus(p),c+=d}while(u!==i.activeElement);return t&6&&focus_management_w(u)&&u.select(),u.hasAttribute("tabindex")||u.setAttribute("tabindex","0"),2}
...
function d(e,r,n){let o=use_latest_value_s(r);(0,external_react_.useEffect)(()=>{function t(u){o.current(u)}return document.addEventListener(e,t,n),()=>document.removeEventListener(e,t,n)},[e,n])}
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@headlessui+react@1.7.7_biqbaboplfbrettd7655fr4n2y/node_modules/@headlessui/react/dist/hooks/use-tracked-pointer.js
...
var Ue=(o=>(o[o.Open=0]="Open",o[o.Closed=1]="Closed",o))(Ue||{}),Be=(o=>(o[o.Single=0]="Single",o[o.Multi=1]="Multi",o))(Be||{}),He=(o=>(o[o.Pointer=0]="Pointer",o[o.Other=1]="Other",o))(He||{}),Ge=(n=>(n[n.OpenListbox=0]="OpenListbox",n[n.CloseListbox=1]="CloseListbox",n[n.GoToOption=2]="GoToOption",n[n.Search=3]="Search",n[n.ClearSearch=4]="ClearSearch",n[n.RegisterOption=5]="RegisterOption",n[n.UnregisterOption=6]="UnregisterOption",n[n.RegisterLabel=7]="RegisterLabel",n))(Ge||{});function q(e,r=o=>o){let o=e.activeOptionIndex!==null?e.options[e.activeOptionIndex]:null,p=focus_management_A(r(e.options.slice()),c=>c.dataRef.current.domRef.current),i=o?p.indexOf(o):null;return i===-1&&(i=null),{options:p,activeOptionIndex:i}}let je={[1](e){return e.dataRef.current.disabled||e.listboxState===1?e:{...e,activeOptionIndex:null,listboxState:1}},[0](e){if(e.dataRef.current.disabled||e.listboxState===0)return e;let r=e.activeOptionIndex,{isSelected:o}=e.dataRef.current,p=e.options.findIndex(i=>o(i.dataRef.current.value));return p!==-1&&(r=p),{...e,listboxState:0,activeOptionIndex:r}},[2](e,r){var i;if(e.dataRef.current.disabled||e.listboxState===1)return e;let o=q(e),p=x(r,{resolveItems:()=>o.options,resolveActiveIndex:()=>o.activeOptionIndex,resolveId:c=>c.id,resolveDisabled:c=>c.dataRef.current.disabled});return{...e,...o,searchQuery:"",activeOptionIndex:p,activationTrigger:(i=r.trigger)!=null?i:1}},[3]:(e,r)=>{if(e.dataRef.current.disabled||e.listboxState===1)return e;let p=e.searchQuery!==""?0:1,i=e.searchQuery+r.value.toLowerCase(),t=(e.activeOptionIndex!==null?e.options.slice(e.activeOptionIndex+p).concat(e.options.slice(0,e.activeOptionIndex+p)):e.options).find(n=>{var T;return!n.dataRef.current.disabled&&((T=n.dataRef.current.textValue)==null?void 0:T.startsWith(i))}),u=t?e.options.indexOf(t):-1;return u===-1||u===e.activeOptionIndex?{...e,searchQuery:i}:{...e,searchQuery:i,activeOptionIndex:u,activationTrigger:1}},[4](e){return e.dataRef.current.disabled||e.listboxState===1||e.searchQuery===""?e:{...e,searchQuery:""}},[5]:(e,r)=>{let o={id:r.id,dataRef:r.dataRef},p=q(e,i=>[...i,o]);return e.activeOptionIndex===null&&e.dataRef.current.isSelected(r.dataRef.current.value)&&(p.activeOptionIndex=p.options.indexOf(o)),{...e,...p}},[6]:(e,r)=>{let o=q(e,p=>{let i=p.findIndex(c=>c.id===r.id);return i!==-1&&p.splice(i,1),p});return{...e,...o,activationTrigger:1}},[7]:(e,r)=>({...e,labelId:r.id})},X=(0,external_react_.createContext)(null);X.displayName="ListboxActionsContext";function B(e){let r=(0,external_react_.useContext)(X);if(r===null){let o=new Error(`<${e} /> is missing a parent <Listbox /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(o,B),o}return r}let listbox_J=(0,external_react_.createContext)(null);listbox_J.displayName="ListboxDataContext";function listbox_H(e){let r=(0,external_react_.useContext)(listbox_J);if(r===null){let o=new Error(`<${e} /> is missing a parent <Listbox /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(o,listbox_H),o}return r}function Ke(e,r){return match_u(r.type,je,e,r)}let Ve=external_react_.Fragment,Ne=C(function(r,o){let{value:p,defaultValue:i,name:c,onChange:t,by:u=(l,f)=>l===f,disabled:n=!1,horizontal:T=!1,multiple:g=!1,...A}=r;const m=T?"horizontal":"vertical";let P=use_sync_refs_y(o),[y=g?[]:void 0,S]=use_controllable_T(p,t,i),[h,s]=(0,external_react_.useReducer)(Ke,{dataRef:(0,external_react_.createRef)(),listboxState:1,options:[],searchQuery:"",labelId:null,activeOptionIndex:null,activationTrigger:1}),a=(0,external_react_.useRef)({static:!1,hold:!1}),x=(0,external_react_.useRef)(null),D=(0,external_react_.useRef)(null),Q=(0,external_react_.useRef)(null),M=use_event_o(typeof u=="string"?(l,f)=>{let v=u;return(l==null?void 0:l[v])===(f==null?void 0:f[v])}:u),L=(0,external_react_.useCallback)(l=>match_u(d.mode,{[1]:()=>y.some(f=>M(f,l)),[0]:()=>M(y,l)}),[y]),d=(0,external_react_.useMemo)(()=>({...h,value:y,disabled:n,mode:g?1:0,orientation:m,compare:M,isSelected:L,optionsPropsRef:a,labelRef:x,buttonRef:D,optionsRef:Q}),[y,n,g,h]);use_iso_morphic_effect_s(()=>{h.dataRef.current=d},[d]),use_outside_click_L([d.buttonRef,d.optionsRef],(l,f)=>{var v;s({type:1}),focus_management_h(f,focus_management_F.Loose)||(l.preventDefault(),(v=d.buttonRef.current)==null||v.focus())},d.listboxState===0);let G=(0,external_react_.useMemo)(()=>({open:d.listboxState===0,disabled:n,value:y}),[d,n,y]),ie=use_event_o(l=>{let f=d.options.find(v=>v.id===l);!f||k(f.dataRef.current.value)}),re=use_event_o(()=>{if(d.activeOptionIndex!==null){let{dataRef:l,id:f}=d.options[d.activeOptionIndex];k(l.current.value),s({type:2,focus:calculate_active_index_a.Specific,id:f})}}),ae=use_event_o(()=>s({type:0})),le=use_event_o(()=>s({type:1})),se=use_event_o((l,f,v)=>l===calculate_active_index_a.Specific?s({type:2,focus:calculate_active_index_a.Specific,id:f,trigger:v}):s({type:2,focus:l,trigger:v})),ue=use_event_o((l,f)=>(s({type:5,id:l,dataRef:f}),()=>s({type:6,id:l}))),pe=use_event_o(l=>(s({type:7,id:l}),()=>s({type:7,id:null}))),k=use_event_o(l=>match_u(d.mode,{[0](){return S==null?void 0:S(l)},[1](){let f=d.value.slice(),v=f.findIndex(w=>M(w,l));return v===-1?f.push(l):f.splice(v,1),S==null?void 0:S(f)}})),de=use_event_o(l=>s({type:3,value:l})),ce=use_event_o(()=>s({type:4})),fe=(0,external_react_.useMemo)(()=>({onChange:k,registerOption:ue,registerLabel:pe,goToOption:se,closeListbox:le,openListbox:ae,selectActiveOption:re,selectOption:ie,search:de,clearSearch:ce}),[]),be={ref:P},j=(0,external_react_.useRef)(null),Te=use_disposables_p();return (0,external_react_.useEffect)(()=>{!j.current||i!==void 0&&Te.addEventListener(j.current,"reset",()=>{k(i)})},[j,k]),external_react_.createElement(X.Provider,{value:fe},external_react_.createElement(listbox_J.Provider,{value:d},external_react_.createElement(open_closed_C,{value:match_u(d.listboxState,{[0]:open_closed_p.Open,[1]:open_closed_p.Closed})},c!=null&&y!=null&&form_e({[c]:y}).map(([l,f],v)=>external_react_.createElement(hidden_h,{features:hidden_s.Hidden,ref:v===0?w=>{var Y;j.current=(Y=w==null?void 0:w.closest("form"))!=null?Y:null}:void 0,...F({key:l,as:"input",type:"hidden",hidden:!0,readOnly:!0,name:l,value:f})})),$({ourProps:be,theirProps:A,slot:G,defaultTag:Ve,name:"Listbox"}))))}),We="button",Qe=C(function(r,o){var h;let p=use_id_I(),{id:i=`headlessui-listbox-button-${p}`,...c}=r,t=listbox_H("Listbox.Button"),u=B("Listbox.Button"),n=use_sync_refs_y(t.buttonRef,o),T=use_disposables_p(),g=use_event_o(s=>{switch(s.key){case keyboard_o.Space:case keyboard_o.Enter:case keyboard_o.ArrowDown:s.preventDefault(),u.openListbox(),T.nextFrame(()=>{t.value||u.goToOption(calculate_active_index_a.First)});break;case keyboard_o.ArrowUp:s.preventDefault(),u.openListbox(),T.nextFrame(()=>{t.value||u.goToOption(calculate_active_index_a.Last)});break}}),A=use_event_o(s=>{switch(s.key){case keyboard_o.Space:s.preventDefault();break}}),m=use_event_o(s=>{if(bugs_r(s.currentTarget))return s.preventDefault();t.listboxState===0?(u.closeListbox(),T.nextFrame(()=>{var a;return(a=t.buttonRef.current)==null?void 0:a.focus({preventScroll:!0})})):(s.preventDefault(),u.openListbox())}),P=use_computed_i(()=>{if(!!t.labelId)return[t.labelId,i].join(" ")},[t.labelId,i]),y=(0,external_react_.useMemo)(()=>({open:t.listboxState===0,disabled:t.disabled,value:t.value}),[t]),S={ref:n,id:i,type:use_resolve_button_type_s(r,t.buttonRef),"aria-haspopup":"listbox","aria-controls":(h=t.optionsRef.current)==null?void 0:h.id,"aria-expanded":t.disabled?void 0:t.listboxState===0,"aria-labelledby":P,disabled:t.disabled,onKeyDown:g,onKeyUp:A,onClick:m};return $({ourProps:S,theirProps:c,slot:y,defaultTag:We,name:"Listbox.Button"})}),$e="label",ze=C(function(r,o){let p=use_id_I(),{id:i=`headlessui-listbox-label-${p}`,...c}=r,t=listbox_H("Listbox.Label"),u=B("Listbox.Label"),n=use_sync_refs_y(t.labelRef,o);use_iso_morphic_effect_s(()=>u.registerLabel(i),[i]);let T=use_event_o(()=>{var m;return(m=t.buttonRef.current)==null?void 0:m.focus({preventScroll:!0})}),g=(0,external_react_.useMemo)(()=>({open:t.listboxState===0,disabled:t.disabled}),[t]);return $({ourProps:{ref:n,id:i,onClick:T},theirProps:c,slot:g,defaultTag:$e,name:"Listbox.Label"})}),qe="ul",Xe=S.RenderStrategy|S.Static,listbox_Je=C(function(r,o){var s;let p=use_id_I(),{id:i=`headlessui-listbox-options-${p}`,...c}=r,t=listbox_H("Listbox.Options"),u=B("Listbox.Options"),n=use_sync_refs_y(t.optionsRef,o),T=use_disposables_p(),g=use_disposables_p(),A=open_closed_s(),m=(()=>A!==null?A===open_closed_p.Open:t.listboxState===0)();(0,external_react_.useEffect)(()=>{var x;let a=t.optionsRef.current;!a||t.listboxState===0&&a!==((x=owner_e(a))==null?void 0:x.activeElement)&&a.focus({preventScroll:!0})},[t.listboxState,t.optionsRef]);let P=use_event_o(a=>{switch(g.dispose(),a.key){case keyboard_o.Space:if(t.searchQuery!=="")return a.preventDefault(),a.stopPropagation(),u.search(a.key);case keyboard_o.Enter:if(a.preventDefault(),a.stopPropagation(),t.activeOptionIndex!==null){let{dataRef:x}=t.options[t.activeOptionIndex];u.onChange(x.current.value)}t.mode===0&&(u.closeListbox(),disposables_m().nextFrame(()=>{var x;return(x=t.buttonRef.current)==null?void 0:x.focus({preventScroll:!0})}));break;case match_u(t.orientation,{vertical:keyboard_o.ArrowDown,horizontal:keyboard_o.ArrowRight}):return a.preventDefault(),a.stopPropagation(),u.goToOption(calculate_active_index_a.Next);case match_u(t.orientation,{vertical:keyboard_o.ArrowUp,horizontal:keyboard_o.ArrowLeft}):return a.preventDefault(),a.stopPropagation(),u.goToOption(calculate_active_index_a.Previous);case keyboard_o.Home:case keyboard_o.PageUp:return a.preventDefault(),a.stopPropagation(),u.goToOption(calculate_active_index_a.First);case keyboard_o.End:case keyboard_o.PageDown:return a.preventDefault(),a.stopPropagation(),u.goToOption(calculate_active_index_a.Last);case keyboard_o.Escape:return a.preventDefault(),a.stopPropagation(),u.closeListbox(),T.nextFrame(()=>{var x;return(x=t.buttonRef.current)==null?void 0:x.focus({preventScroll:!0})});case keyboard_o.Tab:a.preventDefault(),a.stopPropagation();break;default:a.key.length===1&&(u.search(a.key),g.setTimeout(()=>u.clearSearch(),350));break}}),y=use_computed_i(()=>{var a,x,D;return(D=(a=t.labelRef.current)==null?void 0:a.id)!=null?D:(x=t.buttonRef.current)==null?void 0:x.id},[t.labelRef.current,t.buttonRef.current]),S=(0,external_react_.useMemo)(()=>({open:t.listboxState===0}),[t]),h={"aria-activedescendant":t.activeOptionIndex===null||(s=t.options[t.activeOptionIndex])==null?void 0:s.id,"aria-multiselectable":t.mode===1?!0:void 0,"aria-labelledby":y,"aria-orientation":t.orientation,id:i,onKeyDown:P,role:"listbox",tabIndex:0,ref:n};return $({ourProps:h,theirProps:c,slot:S,defaultTag:qe,features:Xe,visible:m,name:"Listbox.Options"})}),Ye="li",Ze=C(function(r,o){let p=use_id_I(),{id:i=`headlessui-listbox-option-${p}`,disabled:c=!1,value:t,...u}=r,n=listbox_H("Listbox.Option"),T=B("Listbox.Option"),g=n.activeOptionIndex!==null?n.options[n.activeOptionIndex].id===i:!1,A=n.isSelected(t),m=(0,external_react_.useRef)(null),P=use_latest_value_s({disabled:c,value:t,domRef:m,get textValue(){var L,d;return(d=(L=m.current)==null?void 0:L.textContent)==null?void 0:d.toLowerCase()}}),y=use_sync_refs_y(o,m);use_iso_morphic_effect_s(()=>{if(n.listboxState!==0||!g||n.activationTrigger===0)return;let L=disposables_m();return L.requestAnimationFrame(()=>{var d,G;(G=(d=m.current)==null?void 0:d.scrollIntoView)==null||G.call(d,{block:"nearest"})}),L.dispose},[m,g,n.listboxState,n.activationTrigger,n.activeOptionIndex]),use_iso_morphic_effect_s(()=>T.registerOption(i,P),[P,i]);let S=use_event_o(L=>{if(c)return L.preventDefault();T.onChange(t),n.mode===0&&(T.closeListbox(),disposables_m().nextFrame(()=>{var d;return(d=n.buttonRef.current)==null?void 0:d.focus({preventScroll:!0})}))}),h=use_event_o(()=>{if(c)return T.goToOption(calculate_active_index_a.Nothing);T.goToOption(calculate_active_index_a.Specific,i)}),s=use_tracked_pointer_u(),a=use_event_o(L=>s.update(L)),x=use_event_o(L=>{!s.wasMoved(L)||c||g||T.goToOption(calculate_active_index_a.Specific,i,0)}),D=use_event_o(L=>{!s.wasMoved(L)||c||!g||T.goToOption(calculate_active_index_a.Nothing)}),Q=(0,external_react_.useMemo)(()=>({active:g,selected:A,disabled:c}),[g,A,c]);return $({ourProps:{id:i,ref:y,role:"option",tabIndex:c===!0?void 0:-1,"aria-disabled":c===!0?!0:void 0,"aria-selected":A,disabled:void 0,onClick:S,onFocus:h,onPointerEnter:a,onMouseEnter:a,onPointerMove:x,onMouseMove:x,onPointerLeave:D,onMouseLeave:D},theirProps:u,slot:Q,defaultTag:Ye,name:"Listbox.Option"})}),Mt=Object.assign(Ne,{Button:Qe,Label:ze,Options:listbox_Je,Option:Ze});

// EXTERNAL MODULE: external "react-dom"
var external_react_dom_ = __webpack_require__(6405);
// EXTERNAL MODULE: ./node_modules/.pnpm/next@13.1.1_biqbaboplfbrettd7655fr4n2y/node_modules/next/dist/client/add-base-path.js
var add_base_path = __webpack_require__(7465);
// EXTERNAL MODULE: external "next/head"
var head_ = __webpack_require__(968);
var head_default = /*#__PURE__*/__webpack_require__.n(head_);
// EXTERNAL MODULE: ./node_modules/.pnpm/next-seo@5.15.0_q76c2b4vyoegvsbrcwkfvimnai/node_modules/next-seo/lib/next-seo.js
var next_seo = __webpack_require__(9653);
...
var pe=(o=>(o[o.Open=0]="Open",o[o.Closed=1]="Closed",o))(pe||{}),de=(o=>(o[o.Pointer=0]="Pointer",o[o.Other=1]="Other",o))(de||{}),me=(e=>(e[e.OpenMenu=0]="OpenMenu",e[e.CloseMenu=1]="CloseMenu",e[e.GoToItem=2]="GoToItem",e[e.Search=3]="Search",e[e.ClearSearch=4]="ClearSearch",e[e.RegisterItem=5]="RegisterItem",e[e.UnregisterItem=6]="UnregisterItem",e))(me||{});function U(t,i=o=>o){let o=t.activeItemIndex!==null?t.items[t.activeItemIndex]:null,s=focus_management_A(i(t.items.slice()),u=>u.dataRef.current.domRef.current),a=o?s.indexOf(o):null;return a===-1&&(a=null),{items:s,activeItemIndex:a}}let fe={[1](t){return t.menuState===1?t:{...t,activeItemIndex:null,menuState:1}},[0](t){return t.menuState===0?t:{...t,menuState:0}},[2]:(t,i)=>{var a;let o=U(t),s=x(i,{resolveItems:()=>o.items,resolveActiveIndex:()=>o.activeItemIndex,resolveId:u=>u.id,resolveDisabled:u=>u.dataRef.current.disabled});return{...t,...o,searchQuery:"",activeItemIndex:s,activationTrigger:(a=i.trigger)!=null?a:1}},[3]:(t,i)=>{let s=t.searchQuery!==""?0:1,a=t.searchQuery+i.value.toLowerCase(),n=(t.activeItemIndex!==null?t.items.slice(t.activeItemIndex+s).concat(t.items.slice(0,t.activeItemIndex+s)):t.items).find(d=>{var l;return((l=d.dataRef.current.textValue)==null?void 0:l.startsWith(a))&&!d.dataRef.current.disabled}),e=n?t.items.indexOf(n):-1;return e===-1||e===t.activeItemIndex?{...t,searchQuery:a}:{...t,searchQuery:a,activeItemIndex:e,activationTrigger:1}},[4](t){return t.searchQuery===""?t:{...t,searchQuery:"",searchActiveItemIndex:null}},[5]:(t,i)=>{let o=U(t,s=>[...s,{id:i.id,dataRef:i.dataRef}]);return{...t,...o}},[6]:(t,i)=>{let o=U(t,s=>{let a=s.findIndex(u=>u.id===i.id);return a!==-1&&s.splice(a,1),s});return{...t,...o,activationTrigger:1}}},G=(0,external_react_.createContext)(null);G.displayName="MenuContext";function O(t){let i=(0,external_react_.useContext)(G);if(i===null){let o=new Error(`<${t} /> is missing a parent <Menu /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(o,O),o}return i}function Te(t,i){return match_u(i.type,fe,t,i)}let menu_ye=external_react_.Fragment,Ie=C(function(i,o){let s=(0,external_react_.useReducer)(Te,{menuState:1,buttonRef:(0,external_react_.createRef)(),itemsRef:(0,external_react_.createRef)(),items:[],searchQuery:"",activeItemIndex:null,activationTrigger:1}),[{menuState:a,itemsRef:u,buttonRef:n},e]=s,d=use_sync_refs_y(o);use_outside_click_L([n,u],(R,A)=>{var g;e({type:1}),focus_management_h(A,focus_management_F.Loose)||(R.preventDefault(),(g=n.current)==null||g.focus())},a===0);let l=use_event_o(()=>{e({type:1})}),f=(0,external_react_.useMemo)(()=>({open:a===0,close:l}),[a,l]),M=i,T={ref:d};return external_react_.createElement(G.Provider,{value:s},external_react_.createElement(open_closed_C,{value:match_u(a,{[0]:open_closed_p.Open,[1]:open_closed_p.Closed})},$({ourProps:T,theirProps:M,slot:f,defaultTag:menu_ye,name:"Menu"})))}),menu_ge="button",Me=C(function(i,o){var g;let s=use_id_I(),{id:a=`headlessui-menu-button-${s}`,...u}=i,[n,e]=O("Menu.Button"),d=use_sync_refs_y(n.buttonRef,o),l=use_disposables_p(),f=use_event_o(c=>{switch(c.key){case keyboard_o.Space:case keyboard_o.Enter:case keyboard_o.ArrowDown:c.preventDefault(),c.stopPropagation(),e({type:0}),l.nextFrame(()=>e({type:2,focus:calculate_active_index_a.First}));break;case keyboard_o.ArrowUp:c.preventDefault(),c.stopPropagation(),e({type:0}),l.nextFrame(()=>e({type:2,focus:calculate_active_index_a.Last}));break}}),M=use_event_o(c=>{switch(c.key){case keyboard_o.Space:c.preventDefault();break}}),T=use_event_o(c=>{if(bugs_r(c.currentTarget))return c.preventDefault();i.disabled||(n.menuState===0?(e({type:1}),l.nextFrame(()=>{var b;return(b=n.buttonRef.current)==null?void 0:b.focus({preventScroll:!0})})):(c.preventDefault(),e({type:0})))}),R=(0,external_react_.useMemo)(()=>({open:n.menuState===0}),[n]),A={ref:d,id:a,type:use_resolve_button_type_s(i,n.buttonRef),"aria-haspopup":"menu","aria-controls":(g=n.itemsRef.current)==null?void 0:g.id,"aria-expanded":i.disabled?void 0:n.menuState===0,onKeyDown:f,onKeyUp:M,onClick:T};return $({ourProps:A,theirProps:u,slot:R,defaultTag:menu_ge,name:"Menu.Button"})}),Re="div",menu_be=S.RenderStrategy|S.Static,Ae=C(function(i,o){var b,S;let s=use_id_I(),{id:a=`headlessui-menu-items-${s}`,...u}=i,[n,e]=O("Menu.Items"),d=use_sync_refs_y(n.itemsRef,o),l=use_owner_n(n.itemsRef),f=use_disposables_p(),M=open_closed_s(),T=(()=>M!==null?M===open_closed_p.Open:n.menuState===0)();(0,external_react_.useEffect)(()=>{let r=n.itemsRef.current;!r||n.menuState===0&&r!==(l==null?void 0:l.activeElement)&&r.focus({preventScroll:!0})},[n.menuState,n.itemsRef,l]),use_tree_walker_F({container:n.itemsRef.current,enabled:n.menuState===0,accept(r){return r.getAttribute("role")==="menuitem"?NodeFilter.FILTER_REJECT:r.hasAttribute("role")?NodeFilter.FILTER_SKIP:NodeFilter.FILTER_ACCEPT},walk(r){r.setAttribute("role","none")}});let R=use_event_o(r=>{var h,F;switch(f.dispose(),r.key){case keyboard_o.Space:if(n.searchQuery!=="")return r.preventDefault(),r.stopPropagation(),e({type:3,value:r.key});case keyboard_o.Enter:if(r.preventDefault(),r.stopPropagation(),e({type:1}),n.activeItemIndex!==null){let{dataRef:p}=n.items[n.activeItemIndex];(F=(h=p.current)==null?void 0:h.domRef.current)==null||F.click()}focus_management_v(n.buttonRef.current);break;case keyboard_o.ArrowDown:return r.preventDefault(),r.stopPropagation(),e({type:2,focus:calculate_active_index_a.Next});case keyboard_o.ArrowUp:return r.preventDefault(),r.stopPropagation(),e({type:2,focus:calculate_active_index_a.Previous});case keyboard_o.Home:case keyboard_o.PageUp:return r.preventDefault(),r.stopPropagation(),e({type:2,focus:calculate_active_index_a.First});case keyboard_o.End:case keyboard_o.PageDown:return r.preventDefault(),r.stopPropagation(),e({type:2,focus:calculate_active_index_a.Last});case keyboard_o.Escape:r.preventDefault(),r.stopPropagation(),e({type:1}),disposables_m().nextFrame(()=>{var p;return(p=n.buttonRef.current)==null?void 0:p.focus({preventScroll:!0})});break;case keyboard_o.Tab:r.preventDefault(),r.stopPropagation(),e({type:1}),disposables_m().nextFrame(()=>{focus_management_g(n.buttonRef.current,r.shiftKey?focus_management_L.Previous:focus_management_L.Next)});break;default:r.key.length===1&&(e({type:3,value:r.key}),f.setTimeout(()=>e({type:4}),350));break}}),A=use_event_o(r=>{switch(r.key){case keyboard_o.Space:r.preventDefault();break}}),g=(0,external_react_.useMemo)(()=>({open:n.menuState===0}),[n]),c={"aria-activedescendant":n.activeItemIndex===null||(b=n.items[n.activeItemIndex])==null?void 0:b.id,"aria-labelledby":(S=n.buttonRef.current)==null?void 0:S.id,id:a,onKeyDown:R,onKeyUp:A,role:"menu",tabIndex:0,ref:d};return $({ourProps:c,theirProps:u,slot:g,defaultTag:Re,features:menu_be,visible:T,name:"Menu.Items"})}),ve=external_react_.Fragment,menu_Se=C(function(i,o){let s=use_id_I(),{id:a=`headlessui-menu-item-${s}`,disabled:u=!1,...n}=i,[e,d]=O("Menu.Item"),l=e.activeItemIndex!==null?e.items[e.activeItemIndex].id===a:!1,f=(0,external_react_.useRef)(null),M=use_sync_refs_y(o,f);use_iso_morphic_effect_s(()=>{if(e.menuState!==0||!l||e.activationTrigger===0)return;let p=disposables_m();return p.requestAnimationFrame(()=>{var v,B;(B=(v=f.current)==null?void 0:v.scrollIntoView)==null||B.call(v,{block:"nearest"})}),p.dispose},[f,l,e.menuState,e.activationTrigger,e.activeItemIndex]);let T=(0,external_react_.useRef)({disabled:u,domRef:f});use_iso_morphic_effect_s(()=>{T.current.disabled=u},[T,u]),use_iso_morphic_effect_s(()=>{var p,v;T.current.textValue=(v=(p=f.current)==null?void 0:p.textContent)==null?void 0:v.toLowerCase()},[T,f]),use_iso_morphic_effect_s(()=>(d({type:5,id:a,dataRef:T}),()=>d({type:6,id:a})),[T,a]);let R=use_event_o(()=>{d({type:1})}),A=use_event_o(p=>{if(u)return p.preventDefault();d({type:1}),focus_management_v(e.buttonRef.current)}),g=use_event_o(()=>{if(u)return d({type:2,focus:calculate_active_index_a.Nothing});d({type:2,focus:calculate_active_index_a.Specific,id:a})}),c=use_tracked_pointer_u(),b=use_event_o(p=>c.update(p)),S=use_event_o(p=>{!c.wasMoved(p)||u||l||d({type:2,focus:calculate_active_index_a.Specific,id:a,trigger:0})}),r=use_event_o(p=>{!c.wasMoved(p)||u||!l||d({type:2,focus:calculate_active_index_a.Nothing})}),h=(0,external_react_.useMemo)(()=>({active:l,disabled:u,close:R}),[l,u,R]);return $({ourProps:{id:a,ref:M,role:"menuitem",tabIndex:u===!0?void 0:-1,"aria-disabled":u===!0?!0:void 0,disabled:void 0,onClick:A,onFocus:g,onPointerEnter:b,onMouseEnter:b,onPointerMove:S,onMouseMove:S,onPointerLeave:r,onMouseLeave:r},theirProps:n,slot:h,defaultTag:ve,name:"Menu.Item"})}),menu_Ze=Object.assign(Ie,{Button:Me,Items:Ae,Item:menu_Se});

;// CONCATENATED MODULE: ./node_modules/.pnpm/github-slugger@2.0.0/node_modules/github-slugger/regex.js
// This module is generated by `script/`.
/* eslint-disable no-control-regex, no-misleading-character-class, no-useless-escape */
const regex = /[\0-\x1F!-,\.\/:-@\[-\^`\{-\xA9\xAB-\xB4\xB6-\xB9\xBB-\xBF\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0378\u0379\u037E\u0380-\u0385\u0387\u038B\u038D\u03A2\u03F6\u0482\u0530\u0557\u0558\u055A-\u055F\u0589-\u0590\u05BE\u05C0\u05C3\u05C6\u05C8-\u05CF\u05EB-\u05EE\u05F3-\u060F\u061B-\u061F\u066A-\u066D\u06D4\u06DD\u06DE\u06E9\u06FD\u06FE\u0700-\u070F\u074B\u074C\u07B2-\u07BF\u07F6-\u07F9\u07FB\u07FC\u07FE\u07FF\u082E-\u083F\u085C-\u085F\u086B-\u089F\u08B5\u08C8-\u08D2\u08E2\u0964\u0965\u0970\u0984\u098D\u098E\u0991\u0992\u09A9\u09B1\u09B3-\u09B5\u09BA\u09BB\u09C5\u09C6\u09C9\u09CA\u09CF-\u09D6\u09D8-\u09DB\u09DE\u09E4\u09E5\u09F2-\u09FB\u09FD\u09FF\u0A00\u0A04\u0A0B-\u0A0E\u0A11\u0A12\u0A29\u0A31\u0A34\u0A37\u0A3A\u0A3B\u0A3D\u0A43-\u0A46\u0A49\u0A4A\u0A4E-\u0A50\u0A52-\u0A58\u0A5D\u0A5F-\u0A65\u0A76-\u0A80\u0A84\u0A8E\u0A92\u0AA9\u0AB1\u0AB4\u0ABA\u0ABB\u0AC6\u0ACA\u0ACE\u0ACF\u0AD1-\u0ADF\u0AE4\u0AE5\u0AF0-\u0AF8\u0B00\u0B04\u0B0D\u0B0E\u0B11\u0B12\u0B29\u0B31\u0B34\u0B3A\u0B3B\u0B45\u0B46\u0B49\u0B4A\u0B4E-\u0B54\u0B58-\u0B5B\u0B5E\u0B64\u0B65\u0B70\u0B72-\u0B81\u0B84\u0B8B-\u0B8D\u0B91\u0B96-\u0B98\u0B9B\u0B9D\u0BA0-\u0BA2\u0BA5-\u0BA7\u0BAB-\u0BAD\u0BBA-\u0BBD\u0BC3-\u0BC5\u0BC9\u0BCE\u0BCF\u0BD1-\u0BD6\u0BD8-\u0BE5\u0BF0-\u0BFF\u0C0D\u0C11\u0C29\u0C3A-\u0C3C\u0C45\u0C49\u0C4E-\u0C54\u0C57\u0C5B-\u0C5F\u0C64\u0C65\u0C70-\u0C7F\u0C84\u0C8D\u0C91\u0CA9\u0CB4\u0CBA\u0CBB\u0CC5\u0CC9\u0CCE-\u0CD4\u0CD7-\u0CDD\u0CDF\u0CE4\u0CE5\u0CF0\u0CF3-\u0CFF\u0D0D\u0D11\u0D45\u0D49\u0D4F-\u0D53\u0D58-\u0D5E\u0D64\u0D65\u0D70-\u0D79\u0D80\u0D84\u0D97-\u0D99\u0DB2\u0DBC\u0DBE\u0DBF\u0DC7-\u0DC9\u0DCB-\u0DCE\u0DD5\u0DD7\u0DE0-\u0DE5\u0DF0\u0DF1\u0DF4-\u0E00\u0E3B-\u0E3F\u0E4F\u0E5A-\u0E80\u0E83\u0E85\u0E8B\u0EA4\u0EA6\u0EBE\u0EBF\u0EC5\u0EC7\u0ECE\u0ECF\u0EDA\u0EDB\u0EE0-\u0EFF\u0F01-\u0F17\u0F1A-\u0F1F\u0F2A-\u0F34\u0F36\u0F38\u0F3A-\u0F3D\u0F48\u0F6D-\u0F70\u0F85\u0F98\u0FBD-\u0FC5\u0FC7-\u0FFF\u104A-\u104F\u109E\u109F\u10C6\u10C8-\u10CC\u10CE\u10CF\u10FB\u1249\u124E\u124F\u1257\u1259\u125E\u125F\u1289\u128E\u128F\u12B1\u12B6\u12B7\u12BF\u12C1\u12C6\u12C7\u12D7\u1311\u1316\u1317\u135B\u135C\u1360-\u137F\u1390-\u139F\u13F6\u13F7\u13FE-\u1400\u166D\u166E\u1680\u169B-\u169F\u16EB-\u16ED\u16F9-\u16FF\u170D\u1715-\u171F\u1735-\u173F\u1754-\u175F\u176D\u1771\u1774-\u177F\u17D4-\u17D6\u17D8-\u17DB\u17DE\u17DF\u17EA-\u180A\u180E\u180F\u181A-\u181F\u1879-\u187F\u18AB-\u18AF\u18F6-\u18FF\u191F\u192C-\u192F\u193C-\u1945\u196E\u196F\u1975-\u197F\u19AC-\u19AF\u19CA-\u19CF\u19DA-\u19FF\u1A1C-\u1A1F\u1A5F\u1A7D\u1A7E\u1A8A-\u1A8F\u1A9A-\u1AA6\u1AA8-\u1AAF\u1AC1-\u1AFF\u1B4C-\u1B4F\u1B5A-\u1B6A\u1B74-\u1B7F\u1BF4-\u1BFF\u1C38-\u1C3F\u1C4A-\u1C4C\u1C7E\u1C7F\u1C89-\u1C8F\u1CBB\u1CBC\u1CC0-\u1CCF\u1CD3\u1CFB-\u1CFF\u1DFA\u1F16\u1F17\u1F1E\u1F1F\u1F46\u1F47\u1F4E\u1F4F\u1F58\u1F5A\u1F5C\u1F5E\u1F7E\u1F7F\u1FB5\u1FBD\u1FBF-\u1FC1\u1FC5\u1FCD-\u1FCF\u1FD4\u1FD5\u1FDC-\u1FDF\u1FED-\u1FF1\u1FF5\u1FFD-\u203E\u2041-\u2053\u2055-\u2070\u2072-\u207E\u2080-\u208F\u209D-\u20CF\u20F1-\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F-\u215F\u2189-\u24B5\u24EA-\u2BFF\u2C2F\u2C5F\u2CE5-\u2CEA\u2CF4-\u2CFF\u2D26\u2D28-\u2D2C\u2D2E\u2D2F\u2D68-\u2D6E\u2D70-\u2D7E\u2D97-\u2D9F\u2DA7\u2DAF\u2DB7\u2DBF\u2DC7\u2DCF\u2DD7\u2DDF\u2E00-\u2E2E\u2E30-\u3004\u3008-\u3020\u3030\u3036\u3037\u303D-\u3040\u3097\u3098\u309B\u309C\u30A0\u30FB\u3100-\u3104\u3130\u318F-\u319F\u31C0-\u31EF\u3200-\u33FF\u4DC0-\u4DFF\u9FFD-\u9FFF\uA48D-\uA4CF\uA4FE\uA4FF\uA60D-\uA60F\uA62C-\uA63F\uA673\uA67E\uA6F2-\uA716\uA720\uA721\uA789\uA78A\uA7C0\uA7C1\uA7CB-\uA7F4\uA828-\uA82B\uA82D-\uA83F\uA874-\uA87F\uA8C6-\uA8CF\uA8DA-\uA8DF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA954-\uA95F\uA97D-\uA97F\uA9C1-\uA9CE\uA9DA-\uA9DF\uA9FF\uAA37-\uAA3F\uAA4E\uAA4F\uAA5A-\uAA5F\uAA77-\uAA79\uAAC3-\uAADA\uAADE\uAADF\uAAF0\uAAF1\uAAF7-\uAB00\uAB07\uAB08\uAB0F\uAB10\uAB17-\uAB1F\uAB27\uAB2F\uAB5B\uAB6A-\uAB6F\uABEB\uABEE\uABEF\uABFA-\uABFF\uD7A4-\uD7AF\uD7C7-\uD7CA\uD7FC-\uD7FF\uE000-\uF8FF\uFA6E\uFA6F\uFADA-\uFAFF\uFB07-\uFB12\uFB18-\uFB1C\uFB29\uFB37\uFB3D\uFB3F\uFB42\uFB45\uFBB2-\uFBD2\uFD3E-\uFD4F\uFD90\uFD91\uFDC8-\uFDEF\uFDFC-\uFDFF\uFE10-\uFE1F\uFE30-\uFE32\uFE35-\uFE4C\uFE50-\uFE6F\uFE75\uFEFD-\uFF0F\uFF1A-\uFF20\uFF3B-\uFF3E\uFF40\uFF5B-\uFF65\uFFBF-\uFFC1\uFFC8\uFFC9\uFFD0\uFFD1\uFFD8\uFFD9\uFFDD-\uFFFF]|\uD800[\uDC0C\uDC27\uDC3B\uDC3E\uDC4E\uDC4F\uDC5E-\uDC7F\uDCFB-\uDD3F\uDD75-\uDDFC\uDDFE-\uDE7F\uDE9D-\uDE9F\uDED1-\uDEDF\uDEE1-\uDEFF\uDF20-\uDF2C\uDF4B-\uDF4F\uDF7B-\uDF7F\uDF9E\uDF9F\uDFC4-\uDFC7\uDFD0\uDFD6-\uDFFF]|\uD801[\uDC9E\uDC9F\uDCAA-\uDCAF\uDCD4-\uDCD7\uDCFC-\uDCFF\uDD28-\uDD2F\uDD64-\uDDFF\uDF37-\uDF3F\uDF56-\uDF5F\uDF68-\uDFFF]|\uD802[\uDC06\uDC07\uDC09\uDC36\uDC39-\uDC3B\uDC3D\uDC3E\uDC56-\uDC5F\uDC77-\uDC7F\uDC9F-\uDCDF\uDCF3\uDCF6-\uDCFF\uDD16-\uDD1F\uDD3A-\uDD7F\uDDB8-\uDDBD\uDDC0-\uDDFF\uDE04\uDE07-\uDE0B\uDE14\uDE18\uDE36\uDE37\uDE3B-\uDE3E\uDE40-\uDE5F\uDE7D-\uDE7F\uDE9D-\uDEBF\uDEC8\uDEE7-\uDEFF\uDF36-\uDF3F\uDF56-\uDF5F\uDF73-\uDF7F\uDF92-\uDFFF]|\uD803[\uDC49-\uDC7F\uDCB3-\uDCBF\uDCF3-\uDCFF\uDD28-\uDD2F\uDD3A-\uDE7F\uDEAA\uDEAD-\uDEAF\uDEB2-\uDEFF\uDF1D-\uDF26\uDF28-\uDF2F\uDF51-\uDFAF\uDFC5-\uDFDF\uDFF7-\uDFFF]|\uD804[\uDC47-\uDC65\uDC70-\uDC7E\uDCBB-\uDCCF\uDCE9-\uDCEF\uDCFA-\uDCFF\uDD35\uDD40-\uDD43\uDD48-\uDD4F\uDD74\uDD75\uDD77-\uDD7F\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDFF\uDE12\uDE38-\uDE3D\uDE3F-\uDE7F\uDE87\uDE89\uDE8E\uDE9E\uDEA9-\uDEAF\uDEEB-\uDEEF\uDEFA-\uDEFF\uDF04\uDF0D\uDF0E\uDF11\uDF12\uDF29\uDF31\uDF34\uDF3A\uDF45\uDF46\uDF49\uDF4A\uDF4E\uDF4F\uDF51-\uDF56\uDF58-\uDF5C\uDF64\uDF65\uDF6D-\uDF6F\uDF75-\uDFFF]|\uD805[\uDC4B-\uDC4F\uDC5A-\uDC5D\uDC62-\uDC7F\uDCC6\uDCC8-\uDCCF\uDCDA-\uDD7F\uDDB6\uDDB7\uDDC1-\uDDD7\uDDDE-\uDDFF\uDE41-\uDE43\uDE45-\uDE4F\uDE5A-\uDE7F\uDEB9-\uDEBF\uDECA-\uDEFF\uDF1B\uDF1C\uDF2C-\uDF2F\uDF3A-\uDFFF]|\uD806[\uDC3B-\uDC9F\uDCEA-\uDCFE\uDD07\uDD08\uDD0A\uDD0B\uDD14\uDD17\uDD36\uDD39\uDD3A\uDD44-\uDD4F\uDD5A-\uDD9F\uDDA8\uDDA9\uDDD8\uDDD9\uDDE2\uDDE5-\uDDFF\uDE3F-\uDE46\uDE48-\uDE4F\uDE9A-\uDE9C\uDE9E-\uDEBF\uDEF9-\uDFFF]|\uD807[\uDC09\uDC37\uDC41-\uDC4F\uDC5A-\uDC71\uDC90\uDC91\uDCA8\uDCB7-\uDCFF\uDD07\uDD0A\uDD37-\uDD39\uDD3B\uDD3E\uDD48-\uDD4F\uDD5A-\uDD5F\uDD66\uDD69\uDD8F\uDD92\uDD99-\uDD9F\uDDAA-\uDEDF\uDEF7-\uDFAF\uDFB1-\uDFFF]|\uD808[\uDF9A-\uDFFF]|\uD809[\uDC6F-\uDC7F\uDD44-\uDFFF]|[\uD80A\uD80B\uD80E-\uD810\uD812-\uD819\uD824-\uD82B\uD82D\uD82E\uD830-\uD833\uD837\uD839\uD83D\uD83F\uD87B-\uD87D\uD87F\uD885-\uDB3F\uDB41-\uDBFF][\uDC00-\uDFFF]|\uD80D[\uDC2F-\uDFFF]|\uD811[\uDE47-\uDFFF]|\uD81A[\uDE39-\uDE3F\uDE5F\uDE6A-\uDECF\uDEEE\uDEEF\uDEF5-\uDEFF\uDF37-\uDF3F\uDF44-\uDF4F\uDF5A-\uDF62\uDF78-\uDF7C\uDF90-\uDFFF]|\uD81B[\uDC00-\uDE3F\uDE80-\uDEFF\uDF4B-\uDF4E\uDF88-\uDF8E\uDFA0-\uDFDF\uDFE2\uDFE5-\uDFEF\uDFF2-\uDFFF]|\uD821[\uDFF8-\uDFFF]|\uD823[\uDCD6-\uDCFF\uDD09-\uDFFF]|\uD82C[\uDD1F-\uDD4F\uDD53-\uDD63\uDD68-\uDD6F\uDEFC-\uDFFF]|\uD82F[\uDC6B-\uDC6F\uDC7D-\uDC7F\uDC89-\uDC8F\uDC9A-\uDC9C\uDC9F-\uDFFF]|\uD834[\uDC00-\uDD64\uDD6A-\uDD6C\uDD73-\uDD7A\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDE41\uDE45-\uDFFF]|\uD835[\uDC55\uDC9D\uDCA0\uDCA1\uDCA3\uDCA4\uDCA7\uDCA8\uDCAD\uDCBA\uDCBC\uDCC4\uDD06\uDD0B\uDD0C\uDD15\uDD1D\uDD3A\uDD3F\uDD45\uDD47-\uDD49\uDD51\uDEA6\uDEA7\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3\uDFCC\uDFCD]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85-\uDE9A\uDEA0\uDEB0-\uDFFF]|\uD838[\uDC07\uDC19\uDC1A\uDC22\uDC25\uDC2B-\uDCFF\uDD2D-\uDD2F\uDD3E\uDD3F\uDD4A-\uDD4D\uDD4F-\uDEBF\uDEFA-\uDFFF]|\uD83A[\uDCC5-\uDCCF\uDCD7-\uDCFF\uDD4C-\uDD4F\uDD5A-\uDFFF]|\uD83B[\uDC00-\uDDFF\uDE04\uDE20\uDE23\uDE25\uDE26\uDE28\uDE33\uDE38\uDE3A\uDE3C-\uDE41\uDE43-\uDE46\uDE48\uDE4A\uDE4C\uDE50\uDE53\uDE55\uDE56\uDE58\uDE5A\uDE5C\uDE5E\uDE60\uDE63\uDE65\uDE66\uDE6B\uDE73\uDE78\uDE7D\uDE7F\uDE8A\uDE9C-\uDEA0\uDEA4\uDEAA\uDEBC-\uDFFF]|\uD83C[\uDC00-\uDD2F\uDD4A-\uDD4F\uDD6A-\uDD6F\uDD8A-\uDFFF]|\uD83E[\uDC00-\uDFEF\uDFFA-\uDFFF]|\uD869[\uDEDE-\uDEFF]|\uD86D[\uDF35-\uDF3F]|\uD86E[\uDC1E\uDC1F]|\uD873[\uDEA2-\uDEAF]|\uD87A[\uDFE1-\uDFFF]|\uD87E[\uDE1E-\uDFFF]|\uD884[\uDF4B-\uDFFF]|\uDB40[\uDC00-\uDCFF\uDDF0-\uDFFF]/g

;// CONCATENATED MODULE: ./node_modules/.pnpm/github-slugger@2.0.0/node_modules/github-slugger/index.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/compute-scroll-into-view@2.0.3/node_modules/compute-scroll-into-view/dist/index.js
let dist_e=e=>"object"==typeof e&&null!=e&&1===e.nodeType,dist_t=(e,t)=>(!t||"hidden"!==e)&&("visible"!==e&&"clip"!==e),n=(e,n)=>{if(e.clientHeight<e.scrollHeight||e.clientWidth<e.scrollWidth){let l=getComputedStyle(e,null);return dist_t(l.overflowY,n)||dist_t(l.overflowX,n)||(e=>{let t=(e=>{if(!e.ownerDocument||!e.ownerDocument.defaultView)return null;try{return e.ownerDocument.defaultView.frameElement}catch(e){return null}})(e);return!!t&&(t.clientHeight<e.scrollHeight||t.clientWidth<e.scrollWidth)})(e)}return!1},dist_l=(e,t,n,l,i,o,r,d)=>o<e&&r>t||o>e&&r<t?0:o<=e&&d<=n||r>=t&&d>=n?o-e-l:r>t&&d<n||o<e&&d>n?r-t+i:0,dist_i=e=>{let t=e.parentElement;return null==t?e.getRootNode().host||null:t};var dist_o=(t,o)=>{var r,d,h,f,u,s;if("undefined"==typeof document)return[];let{scrollMode:a,block:c,inline:g,boundary:m,skipOverflowHiddenElements:p}=o,w="function"==typeof m?m:e=>e!==m;if(!dist_e(t))throw new TypeError("Invalid target");let W=document.scrollingElement||document.documentElement,H=[],b=t;for(;dist_e(b)&&w(b);){if(b=dist_i(b),b===W){H.push(b);break}null!=b&&b===document.body&&n(b)&&!n(document.documentElement)||null!=b&&n(b,p)&&H.push(b)}let v=null!=(d=null==(r=window.visualViewport)?void 0:r.width)?d:innerWidth,y=null!=(f=null==(h=window.visualViewport)?void 0:h.height)?f:innerHeight,E=null!=(u=window.scrollX)?u:pageXOffset,M=null!=(s=window.scrollY)?s:pageYOffset,{height:x,width:I,top:C,right:R,bottom:T,left:V}=t.getBoundingClientRect(),k="start"===c||"nearest"===c?C:"end"===c?T:C+x/2,B="center"===g?V+I/2:"end"===g?R:V,D=[];for(let e=0;e<H.length;e++){let t=H[e],{height:n,width:i,top:o,right:r,bottom:d,left:h}=t.getBoundingClientRect();if("if-needed"===a&&C>=0&&V>=0&&T<=y&&R<=v&&C>=o&&T<=d&&V>=h&&R<=r)return D;let f=getComputedStyle(t),u=parseInt(f.borderLeftWidth,10),s=parseInt(f.borderTopWidth,10),m=parseInt(f.borderRightWidth,10),p=parseInt(f.borderBottomWidth,10),w=0,b=0,O="offsetWidth"in t?t.offsetWidth-t.clientWidth-u-m:0,X="offsetHeight"in t?t.offsetHeight-t.clientHeight-s-p:0,Y="offsetWidth"in t?0===t.offsetWidth?0:i/t.offsetWidth:0,L="offsetHeight"in t?0===t.offsetHeight?0:n/t.offsetHeight:0;if(W===t)w="start"===c?k:"end"===c?k-y:"nearest"===c?dist_l(M,M+y,y,s,p,M+k,M+k+x,x):k-y/2,b="start"===g?B:"center"===g?B-v/2:"end"===g?B-v:dist_l(E,E+v,v,u,m,E+B,E+B+I,I),w=Math.max(0,w+M),b=Math.max(0,b+E);else{w="start"===c?k-o-s:"end"===c?k-d+p+X:"nearest"===c?dist_l(o,d,n,s,p+X,k,k+x,x):k-(o+n/2)+X/2,b="start"===g?B-h-u:"center"===g?B-(h+i/2)+O/2:"end"===g?B-r+m+O:dist_l(h,r,i,u,m+O,B,B+I,I);let{scrollLeft:e,scrollTop:f}=t;w=Math.max(0,Math.min(f+w/L,t.scrollHeight-n/L+X)),b=Math.max(0,Math.min(e+b/Y,t.scrollWidth-i/Y+O)),k+=f-w,B+=e-b}D.push({el:t,top:w,left:b})}return D};//# sourceMappingURL=index.js.map
...
let scroll_into_view_if_needed_dist_t=e=>!1===e?{block:"end",inline:"nearest"}:(e=>e===Object(e)&&0!==Object.keys(e).length)(e)?e:{block:"start",inline:"nearest"};function scroll_into_view_if_needed_dist_o(o,l){let n=o.isConnected||o.ownerDocument.documentElement.contains(o);if((e=>"object"==typeof e&&"function"==typeof e.behavior)(l))return l.behavior(n?dist_o(o,l):[]);if(!n)return;let r=scroll_into_view_if_needed_dist_t(l),c=dist_o(o,r),i="scrollBehavior"in document.body.style;c.forEach((e=>{let{el:t,top:o,left:l}=e;t.scroll&&i?t.scroll({top:o,left:l,behavior:r.behavior}):(t.scrollTop=o,t.scrollLeft=l)}))}
...
var tabs_pe=(n=>(n[n.SetSelectedIndex=0]="SetSelectedIndex",n[n.RegisterTab=1]="RegisterTab",n[n.UnregisterTab=2]="UnregisterTab",n[n.RegisterPanel=3]="RegisterPanel",n[n.UnregisterPanel=4]="UnregisterPanel",n))(tabs_pe||{});let tabs_fe={[0](e,t){let r=e.tabs.filter(c=>{var s;return!((s=c.current)!=null&&s.hasAttribute("disabled"))});if(t.index<0)return{...e,selectedIndex:e.tabs.indexOf(r[0])};if(t.index>e.tabs.length)return{...e,selectedIndex:e.tabs.indexOf(r[r.length-1])};let i=e.tabs.slice(0,t.index),n=[...e.tabs.slice(t.index),...i].find(c=>r.includes(c));return n?{...e,selectedIndex:e.tabs.indexOf(n)}:e},[1](e,t){var n;if(e.tabs.includes(t.tab))return e;let r=e.tabs[e.selectedIndex],i=focus_management_A([...e.tabs,t.tab],c=>c.current),o=(n=i.indexOf(r))!=null?n:e.selectedIndex;return o===-1&&(o=e.selectedIndex),{...e,tabs:i,selectedIndex:o}},[2](e,t){return{...e,tabs:e.tabs.filter(r=>r!==t.tab)}},[3](e,t){return e.panels.includes(t.panel)?e:{...e,panels:focus_management_A([...e.panels,t.panel],r=>r.current)}},[4](e,t){return{...e,panels:e.panels.filter(r=>r!==t.panel)}}},tabs_q=(0,external_react_.createContext)(null);tabs_q.displayName="TabsSSRContext";function tabs_J(e){let t=(0,external_react_.useContext)(tabs_q);if(t===null){let r=new Error(`<${e} /> is missing a parent <Tab.Group /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(r,tabs_J),r}return t}let Q=(0,external_react_.createContext)(null);Q.displayName="TabsDataContext";function tabs_M(e){let t=(0,external_react_.useContext)(Q);if(t===null){let r=new Error(`<${e} /> is missing a parent <Tab.Group /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(r,tabs_M),r}return t}let tabs_X=(0,external_react_.createContext)(null);tabs_X.displayName="TabsActionsContext";function Y(e){let t=(0,external_react_.useContext)(tabs_X);if(t===null){let r=new Error(`<${e} /> is missing a parent <Tab.Group /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(r,Y),r}return t}function tabs_be(e,t){return match_u(t.type,tabs_fe,e,t)}let tabs_Te=external_react_.Fragment,tabs_me=C(function(t,r){let{defaultIndex:i=0,vertical:o=!1,manual:n=!1,onChange:c,selectedIndex:s=null,...L}=t;const g=o?"vertical":"horizontal",A=n?"manual":"auto";let d=s!==null,v=use_sync_refs_y(r),[p,l]=(0,external_react_.useReducer)(tabs_be,{selectedIndex:s!=null?s:i,tabs:[],panels:[]}),P=(0,external_react_.useMemo)(()=>({selectedIndex:p.selectedIndex}),[p.selectedIndex]),E=use_latest_value_s(c||(()=>{})),f=use_latest_value_s(p.tabs),b=(0,external_react_.useMemo)(()=>({orientation:g,activation:A,...p}),[g,A,p]),y=use_event_o(u=>(l({type:1,tab:u}),()=>l({type:2,tab:u}))),I=use_event_o(u=>(l({type:3,panel:u}),()=>l({type:4,panel:u}))),R=use_event_o(u=>{k.current!==u&&E.current(u),d||l({type:0,index:u})}),k=use_latest_value_s(d?t.selectedIndex:p.selectedIndex),G=(0,external_react_.useMemo)(()=>({registerTab:y,registerPanel:I,change:R}),[]);use_iso_morphic_effect_s(()=>{l({type:0,index:s!=null?s:i})},[s]);let j=(0,external_react_.useRef)({tabs:[],panels:[]}),W={ref:v};return external_react_.createElement(tabs_q.Provider,{value:j},external_react_.createElement(tabs_X.Provider,{value:G},external_react_.createElement(Q.Provider,{value:b},b.tabs.length<=0&&external_react_.createElement(focus_sentinel_p,{onFocus:()=>{var u,C;for(let a of f.current)if(((u=a.current)==null?void 0:u.tabIndex)===0)return(C=a.current)==null||C.focus(),!0;return!1}}),$({ourProps:W,theirProps:L,slot:P,defaultTag:tabs_Te,name:"Tabs"}))))}),tabs_Pe="div",tabs_xe=C(function(t,r){let{orientation:i,selectedIndex:o}=tabs_M("Tab.List"),n=use_sync_refs_y(r);return $({ourProps:{ref:n,role:"tablist","aria-orientation":i},theirProps:t,slot:{selectedIndex:o},defaultTag:tabs_Pe,name:"Tabs.List"})}),tabs_ge="button",tabs_ye=C(function(t,r){var u,C;let i=use_id_I(),{id:o=`headlessui-tabs-tab-${i}`,...n}=t,{orientation:c,activation:s,selectedIndex:L,tabs:g,panels:A}=tabs_M("Tab"),d=Y("Tab"),v=tabs_M("Tab"),p=tabs_J("Tab"),l=(0,external_react_.useRef)(null),P=use_sync_refs_y(l,r);use_iso_morphic_effect_s(()=>d.registerTab(l),[d,l]);let E=p.current.tabs.indexOf(o);E===-1&&(E=p.current.tabs.push(o)-1);let f=g.indexOf(l);f===-1&&(f=E);let b=f===L,y=use_event_o(a=>{var N;let x=a();if(x===focus_management_N.Success&&s==="auto"){let B=(N=owner_e(l))==null?void 0:N.activeElement,Z=v.tabs.findIndex(ae=>ae.current===B);Z!==-1&&d.change(Z)}return x}),I=use_event_o(a=>{let x=g.map(B=>B.current).filter(Boolean);if(a.key===keyboard_o.Space||a.key===keyboard_o.Enter){a.preventDefault(),a.stopPropagation(),d.change(f);return}switch(a.key){case keyboard_o.Home:case keyboard_o.PageUp:return a.preventDefault(),a.stopPropagation(),y(()=>focus_management_I(x,focus_management_L.First));case keyboard_o.End:case keyboard_o.PageDown:return a.preventDefault(),a.stopPropagation(),y(()=>focus_management_I(x,focus_management_L.Last))}if(y(()=>match_u(c,{vertical(){return a.key===keyboard_o.ArrowUp?focus_management_I(x,focus_management_L.Previous|focus_management_L.WrapAround):a.key===keyboard_o.ArrowDown?focus_management_I(x,focus_management_L.Next|focus_management_L.WrapAround):focus_management_N.Error},horizontal(){return a.key===keyboard_o.ArrowLeft?focus_management_I(x,focus_management_L.Previous|focus_management_L.WrapAround):a.key===keyboard_o.ArrowRight?focus_management_I(x,focus_management_L.Next|focus_management_L.WrapAround):focus_management_N.Error}}))===focus_management_N.Success)return a.preventDefault()}),R=(0,external_react_.useRef)(!1),k=use_event_o(()=>{var a;R.current||(R.current=!0,(a=l.current)==null||a.focus(),d.change(f),micro_task_t(()=>{R.current=!1}))}),G=use_event_o(a=>{a.preventDefault()}),j=(0,external_react_.useMemo)(()=>({selected:b}),[b]),W={ref:P,onKeyDown:I,onMouseDown:G,onClick:k,id:o,role:"tab",type:use_resolve_button_type_s(t,l),"aria-controls":(C=(u=A[f])==null?void 0:u.current)==null?void 0:C.id,"aria-selected":b,tabIndex:b?0:-1};return $({ourProps:W,theirProps:n,slot:j,defaultTag:tabs_ge,name:"Tabs.Tab"})}),tabs_Re="div",tabs_Ae=C(function(t,r){let{selectedIndex:i}=tabs_M("Tab.Panels"),o=use_sync_refs_y(r),n=(0,external_react_.useMemo)(()=>({selectedIndex:i}),[i]);return $({ourProps:{ref:o},theirProps:t,slot:n,defaultTag:tabs_Re,name:"Tabs.Panels"})}),tabs_Ee="div",tabs_Se=S.RenderStrategy|S.Static,Le=C(function(t,r){var b,y,I,R;let i=use_id_I(),{id:o=`headlessui-tabs-panel-${i}`,...n}=t,{selectedIndex:c,tabs:s,panels:L}=tabs_M("Tab.Panel"),g=Y("Tab.Panel"),A=tabs_J("Tab.Panel"),d=(0,external_react_.useRef)(null),v=use_sync_refs_y(d,r);use_iso_morphic_effect_s(()=>g.registerPanel(d),[g,d]);let p=A.current.panels.indexOf(o);p===-1&&(p=A.current.panels.push(o)-1);let l=L.indexOf(d);l===-1&&(l=p);let P=l===c,E=(0,external_react_.useMemo)(()=>({selected:P}),[P]),f={ref:v,id:o,role:"tabpanel","aria-labelledby":(y=(b=s[l])==null?void 0:b.current)==null?void 0:y.id,tabIndex:P?0:-1};return!P&&((I=n.unmount)!=null?I:!0)&&!((R=n.static)!=null&&R)?external_react_.createElement(hidden_h,{as:"span",...f}):$({ourProps:f,theirProps:n,slot:E,defaultTag:tabs_Ee,features:tabs_Se,visible:P,name:"Tabs.Panel"})}),tabs_Je=Object.assign(tabs_ye,{Group:tabs_me,List:tabs_xe,Panels:tabs_Ae,Panel:Le});
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/nextra-theme-docs@2.0.2_q76c2b4vyoegvsbrcwkfvimnai/node_modules/nextra-theme-docs/dist/index.js
...
function Search({
  ...
  const icon = /* @__PURE__ */ external_react_default().createElement(Je, {
  ...
  return /* @__PURE__ */ external_react_default().createElement("div", {
    ...
    suffix: icon
  }), /* @__PURE__ */ external_react_default().createElement(Je, {
    show: renderList,
    as: Je.Child,
...
function Select({
  ...
  return /* @__PURE__ */ external_react_default().createElement(Mt, {
    value: selected,
    onChange
  }, ({ open }) => /* @__PURE__ */ external_react_default().createElement(Mt.Button, {
    ref: trigger,
    title,
    className: external_clsx_default()(
  ...
  }, selected.name, /* @__PURE__ */ external_react_default().createElement(Portal, null, /* @__PURE__ */ external_react_default().createElement(Je, {
    ref: container,
    show: open,
    as: Mt.Options,
    ...
    leaveFrom: "nx-opacity-100",
    leaveTo: "nx-opacity-0"
  }, options.map((option) => /* @__PURE__ */ external_react_default().createElement(Mt.Option, {
    key: option.key,
    value: option,
...
var classes3 = {
  ...
  active: external_clsx_default()("nx-font-medium nx-subpixel-antialiased"),
...
function NavbarMenu({
  ...
  return /* @__PURE__ */ external_react_default().createElement("div", {
  ...
  }, /* @__PURE__ */ external_react_default().createElement(menu_Ze, null, /* @__PURE__ */ external_react_default().createElement(menu_Ze.Button, {
    className: external_clsx_default()(
      className,
      "-nx-ml-2 nx-hidden nx-items-center nx-whitespace-nowrap nx-rounded nx-p-2 md:nx-inline-flex",
      classes3.inactive
    )
  }, children), /* @__PURE__ */ external_react_default().createElement(Je, {
    leave: "nx-transition-opacity",
    leaveFrom: "nx-opacity-100",
    leaveTo: "nx-opacity-0"
  }, /* @__PURE__ */ external_react_default().createElement(menu_Ze.Items, {
    ...
    var _a;
    return /* @__PURE__ */ external_react_default().createElement(menu_Ze.Item, {
      key
    }, /* @__PURE__ */ external_react_default().createElement(Anchor, {
...
function Sidebar({
  ...
  (0,external_react_.useEffect)(() => {
    ...
    if (activeElement && (window.innerWidth > 767 || menu)) {
      const scroll = () => {
        scroll_into_view_if_needed_dist_o(activeElement, {
          block: "center",
          inline: "center",
          scrollMode: "always",
...
var SkipNavLink = (0,external_react_.forwardRef)(
  function(_a, forwardedRef) {
    ...
    const className = providedClassName !== void 0 ? providedClassName : styled ? external_clsx_default()(
      "nx-sr-only",
    ...
    return /* @__PURE__ */ external_react_default().createElement("a", __spreadProps(__spreadValues({}, props), {
      ref: forwardedRef,
      href: `#${id || DEFAULT_ID}`,
      className,
...
var SkipNavContent = (0,external_react_.forwardRef)(
  function(_a, forwardedRef) {
    ...
    return /* @__PURE__ */ external_react_default().createElement("div", __spreadProps(__spreadValues({}, props), {
      ref: forwardedRef,
      id: id || DEFAULT_ID
    }));
  }
...
function Tabs({
  ...
  return /* @__PURE__ */ external_react_default().createElement(tabs_Je.Group, {
    selectedIndex,
    defaultIndex,
    onChange
  }, /* @__PURE__ */ external_react_default().createElement("div", {
    className: "no-scrollbar -nx-m-2 nx-overflow-x-auto nx-overflow-y-hidden nx-overscroll-x-contain nx-p-2"
  }, /* @__PURE__ */ external_react_default().createElement(tabs_Je.List, {
    ...
    return /* @__PURE__ */ external_react_default().createElement(tabs_Je, {
      key: index,
      disabled,
  ...
  }))), /* @__PURE__ */ external_react_default().createElement(tabs_Je.Panels, null, children));
}
function Tab(_a) {
  var _b = _a, {
    children
  ...
  return /* @__PURE__ */ external_react_default().createElement(tabs_Je.Panel, __spreadProps(__spreadValues({}, props), {
...
function TOC({ headings, filePath }) {
  ...
  (0,external_react_.useEffect)(() => {
    ...
    if (anchor) {
      scroll_into_view_if_needed_dist_o(anchor, {
        behavior: "smooth",
        block: "center",
        inline: "center",
        scrollMode: "always",
...
var DEFAULT_THEME = {
  ...
  gitTimestamp({ timestamp }) {
    ...
    return /* @__PURE__ */ external_react_default().createElement((external_react_default()).Fragment, null, "Last updated on", " ", /* @__PURE__ */ external_react_default().createElement("time", {
...
var Pre = (_a) => {
  ...
  const [codeString, setCodeString] = (0,external_react_.useState)(value);
  ...
  return /* @__PURE__ */ external_react_default().createElement((external_react_default()).Fragment, null, filename && /* @__PURE__ */ external_react_default().createElement("div", {
    ...
    className: "nx-pointer-events-none nx-h-4 nx-w-4"
  })), codeString && /* @__PURE__ */ external_react_default().createElement(CopyToClipboard, {
    value: codeString
  })));
};
...
var getComponents = ({
  ...
  return __spreadValues({
    ...
    a: (props) => /* @__PURE__ */ external_react_default().createElement(dist_A, __spreadProps(__spreadValues({}, props), {
      className: "nx-text-primary-600 nx-underline nx-decoration-from-font [text-underline-position:under]"
    })),
...
var Body = ({
  ...
  const gitTimestampEl = mounted && date ? /* @__PURE__ */ external_react_default().createElement("div", {
...
var InnerLayout = ({
  ...
  }), tocEl, /* @__PURE__ */ external_react_default().createElement(SkipNavContent, null), /* @__PURE__ */ external_react_default().createElement(Body, {
    themeContext,
